...
file_read = open("D:/Projects/Chouette/txt/read-2018.txt","r")
...
file_write = open("D:/Projects/Chouette/txt/new-read-2018.txt","w")
file_write.write(temp120)
file_write.close()

file_new_read = open("D:/Projects/Chouette/txt/new-read-2018.txt","r")
...
for i in range(0,len(tab_initial)):
    ...
    key_each = line[1+nb_nom].replace('nÂ°','')

    if ( nom[len(nom)-1].upper() == nom[len(nom)-1] ):
        key = key_each + '0'
        key_equip = key
        l=3
    else:
...
file_tab_general = open("D:/Projects/Chouette/javascripts/tab-general-2018.js","w")
file_tab_general.write("let tab_general_2018 = " + temp55 + ";")
file_tab_general.close()

temp77 = str(tab_autocomplete)
temp88 = temp77.replace(', [',',\n[')

file_tab_autocomplete = open("D:/Projects/Chouette/javascripts/tab-autocomplete-2018.js","w")
file_tab_autocomplete.write("let tab_autocomplete_2018 = " + temp88 + ";")
